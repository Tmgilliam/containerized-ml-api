...
class ExperimentAnalyzer:
    ...
    def analyze_conversion_rate(
        ...
        control_std = control_std if 0 < control_rate < 1 else 0
        treatment_std = math.sqrt(treatment_rate * (1 - treatment_rate))
        treatment_std = treatment_std if 0 < treatment_rate < 1 else 0
        ...
        pooled_rate = (control_conversions + treatment_conversions) / total
        pooled_std = math.sqrt(pooled_rate * (1 - pooled_rate))
        pooled_std = pooled_std if 0 < pooled_rate < 1 else 0
