...
class ShadowPrediction:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "shadow_latency_ms": round(self.shadow_latency_ms, 2) if self.shadow_latency_ms else None,
...
class ShadowRunner:
    ...
    def _compare_results(
        ...
        prob_diff = abs(prod_prob - shadow_prob) if prod_prob is not None and shadow_prob is not None else None
